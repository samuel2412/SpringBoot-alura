...
public class TopicosController {
	@Autowired
	private TopicoRepository topicoReposity;

	@Autowired
	private CursoRepository cursoReposity;
	...
	public List<TopicoDto> topicos(String nomeCurso) {
		if (nomeCurso == null) {
			...
			List<Topico> topicos = topicoReposity.findByCursoNome(nomeCurso);
			return TopicoDto.converter(topicos);
		}
	}
	...
	public ResponseEntity<TopicoDto> cadastrar(@RequestBody @Valid TopicoForm form, UriComponentsBuilder uriBuilder) {
		...
		Topico topico = form.converter(cursoReposity);
